...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SB</b>H</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sbobet</b> home</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <?= image_asset('user2-160x160.jpg', 'admin', array("class" => "img-circle", "alt"=> "User Image")); ?>
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <?= image_asset('user2-160x160.jpg', 'admin', array("class" => "user-image", "alt"=> "User Image")); ?>
